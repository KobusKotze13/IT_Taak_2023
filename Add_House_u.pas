...
procedure TfrmAddHouse.DisplayItem;
var
  i: integer;
begin
...
procedure TfrmAddHouse.pnlAddOrderBtnClick(Sender: TObject);
begin
  SavePriceAndItem;
  DisplayItem;
end;
...
procedure TfrmAddHouse.pnlFinalOrderClick(Sender: TObject);
var
  Reciept: textfile;
begin
...
procedure TfrmAddHouse.pnlLogoutClick(Sender: TObject);
begin
  frmLogin.Show;
  frmPOS.Close;
end;
...
procedure TfrmAddHouse.pnlManageStaffBtnClick(Sender: TObject);
begin
  frmStaff.Show;
  frmStaff.Close;
  frmStaff.Show;
...
procedure TfrmAddHouse.pnlManageStockBtnClick(Sender: TObject);
begin
  frmStock.Show;
  frmStock.Close;
  frmStock.Show;
...
procedure TfrmAddHouse.SavePriceAndItem;
var
  i: integer;
begin
